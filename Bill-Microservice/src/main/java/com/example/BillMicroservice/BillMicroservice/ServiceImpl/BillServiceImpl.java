package com.example.BillMicroservice.BillMicroservice.ServiceImpl;
...
import com.example.BillMicroservice.BillMicroservice.dao.BillDao;
import com.example.BillMicroservice.BillMicroservice.jwt.JwtFilter;
    ...
    public ResponseEntity<String> generateReport(Map<String, Object> requestMap) {
        try {
            ...
            if(this.validateRequestMap(requestMap)){
                ...
                Paragraph chunk = new Paragraph("V6 Restaurant", this.getFont("Header"));
